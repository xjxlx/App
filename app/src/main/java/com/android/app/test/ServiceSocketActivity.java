...
public class ServiceSocketActivity extends BaseBindingTitleActivity<ActivityServiceSocketBinding> {
    ...
    @NonNull
    @Override
    public ActivityServiceSocketBinding getBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, boolean attachToRoot) {
