...
public class TestIpActivity extends BaseBindingTitleActivity<ActivityTestIpBinding> {
            ...
            try {
                ...
                if (mClientBufferedReader == null) {
                    mClientBufferedReader = new BufferedReader(
                            new InputStreamReader(mClientSocket.getInputStream(), charsetName));
                }
    ...
    @NonNull
    @Override
    public ActivityTestIpBinding getBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, boolean attachToRoot) {
