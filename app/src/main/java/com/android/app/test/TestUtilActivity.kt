...
class TestUtilActivity : BaseBindingTitleActivity<ActivityTestUtilBinding>() {
    ...
    override fun getBinding(inflater: LayoutInflater, container: ViewGroup?, attachToRoot: Boolean): ActivityTestUtilBinding {
    ...
    override fun initData(savedInstanceState: Bundle?) {
        mBinding.btnTest.setOnClickListener {
            // [{"pc":
            // "http://cdn.smartservice.bjev.com.cn/2021/09/02/07bd10223f5c45a098b154e7a2d51d8e.gif",
            // "isDefalut": 1}]
            val json =
            ...
            RxUtil.Builder(this).build().countdown(100 * 60 * 60 * 1000, 0, 1000, object : CountdownListener {
                /**
