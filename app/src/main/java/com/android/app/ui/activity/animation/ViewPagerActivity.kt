...
import com.android.app.test.banner.BannerQTFragment
...
//            .start(this)
        ...
        val newInstance = BannerQTFragment.newInstance()
        var fragmentUtil = FragmentUtil(mContext)
        fragmentUtil.replace(R.id.fl_content2, newInstance, "", null)
    }
