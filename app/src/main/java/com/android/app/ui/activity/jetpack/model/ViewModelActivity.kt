 ...
 * ```
 */
class ViewModelActivity : BaseBindingTitleActivity<ActivityViewModelBinding>() {
    ...
    override fun initListener() {
        ...
        mBinding.btnHp.setOnClickListener { viewModel.name = "张淑兰" }

        mBinding.btnSp.setOnClickListener { viewModel.name = "李芳华" }
    }
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        util.autoHide(true).add(R.id.fl_content2, Model2Fragment.getInstance(), "") { success, tag, t ->
    ...
    override fun getBinding(inflater: LayoutInflater, container: ViewGroup?, attachToRoot: Boolean): ActivityViewModelBinding {
