...
class RouseDingDingActivity : BaseBindingTitleActivity<ActivityRouseDingDingBinding>() {
    ...
    override fun getBinding(inflater: LayoutInflater, container: ViewGroup?, attachToRoot: Boolean): ActivityRouseDingDingBinding {
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        LocationUtil.Builder(mActivity).setLoop(true).setInterval(5000).setBackgroundRunning(true).setLocationListener { aMapLocation ->
        ...
        mBinding.btnSearch.setOnClickListener { register.launch(intent) } // 长安点击获取屏幕位置
    ...
    private fun locationPoint() { // 实现定位蓝点
        ...
        myLocationStyle.strokeColor(ResourcesUtil.getColor(mActivity, R.color.red_9)) // 设置定位蓝点精度圆圈的边框颜色的方法。
